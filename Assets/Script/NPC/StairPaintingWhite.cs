...
public class StairPaintingWhite : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag == "Stairs" || other.gameObject.tag == "Yellow Stairs" || other.gameObject.tag == "Red Stairs" || other.gameObject.tag == "Blue Stairs")
        {
            if (brickTransformParent.transform.childCount > 0)
            {
                other.gameObject.GetComponent<MeshRenderer>().enabled = true;
                other.gameObject.GetComponent<MeshRenderer>().material = stairsMat;
                other.gameObject.tag = "White Stairs";
